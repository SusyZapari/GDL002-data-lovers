...
const newArrayToTest = window.roadEye.filtersYears(injuriesJSON);
const newArrayToSort = window.roadEye.newArrBiciYear(newArrayToTest);

describe('filtersYears', () => {
  it('deberia ser una funcion', () => {
    expect(typeof (window.roadEye.filtersYears)).toBe('function');
  });

  it('debería devolver la data filtrada', () => {
    expect(window.roadEye.filtersYears(injuriesJSON)).toEqual([{
...
describe('newArrBiciYear', () => {
  it('deberia ser una funcion', () => {
    expect(typeof (window.roadEye.newArrBiciYear)).toBe('function');
  });

  it('newArrayToTest debe devolver un arreglo de arreglos', () => {
    expect(window.roadEye.newArrBiciYear(newArrayToTest)).toEqual(
